...
const routes = [
    ...
    {
        path: 'detailalmacen',
        loadChildren: () => Promise.all(/*! import() | detailalmacen-detailalmacen-module */[__webpack_require__.e("common"), __webpack_require__.e("detailalmacen-detailalmacen-module")]).then(__webpack_require__.bind(null, /*! ./detailalmacen/detailalmacen.module */ "./src/app/detailalmacen/detailalmacen.module.ts")).then(m => m.DetailalmacenPageModule)
    },
    {
        path: 'detailprima',
    ...
    {
        path: 'ventas',
        loadChildren: () => Promise.all(/*! import() | ventas-ventas-module */[__webpack_require__.e("common"), __webpack_require__.e("ventas-ventas-module")]).then(__webpack_require__.bind(null, /*! ./ventas/ventas.module */ "./src/app/ventas/ventas.module.ts")).then(m => m.VentasPageModule)
    },
    {
        path: '',
...
let AppComponent = class AppComponent {
    constructor(host, platform, splashScreen, statusBar) {
        this.host = host;
...
let LoginPage = class LoginPage {
    constructor(router, toastController, host, http, form) {
        this.router = router;
...
module.exports = __webpack_require__(/*! C:\Users\jigma\OneDrive\Escritorio\resApk\src\main.ts */"./src/main.ts");
